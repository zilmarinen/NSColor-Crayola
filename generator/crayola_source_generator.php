...
$header_filename = "NSColor+Crayola.h";
$main_filename = "NSColor+Crayola.m";
$markdown_filename = "README.md";

$image_width = 32;
$image_height = 32;

$github_url = "https://raw.github.com/CaptainRedmuff/NSColor-Crayola/master/";
...
$main_file_meta .= "\n";
$main_file_meta .= "@implementation NSColor (Crayola)\n\n";

$main_file_footer_meta = "@end\n";

$markdown_file_meta = "NSColor+Crayola\n";
$markdown_file_meta .= "===============\n\n";
$markdown_file_meta .= "NSColor category - because everybody loves wax crayons!\n\n";
...
{
	$name = nscolor_name($value);
	$color = nscolor_from_hex($key);
	...
	$markdown_code = nscolor_table_row($value, $key, $image_width, $image_height, $github_url . "images/");
...
$main_code .= "\t\t[cache setName:@\"NSColor+Crayola\"];\n";
$main_code .= "\t}\n\n";
...
$main_code .= "\tif(!color)\n";
$main_code .= "\t{\n";
$main_code .= "\t\tcolor = [NSColor colorWithDeviceRed:red green:green blue:blue alpha:alpha];\n\n";
$main_code .= "\t\t[cache setObject:color forKey:cacheKey];\n";
$main_code .= "\t}\n\n";
$main_code .= "\treturn color;\n";
$main_code .= "}\n\n";
$main_code .= "+ (NSString *)colorWithCalibratedRed:(CGFloat)red green:(CGFloat)green blue:(CGFloat)blue alpha:(CGFloat)alpha\n";
$main_code .= "{\n";
